<?php
    include_once "handlers/database_connection.php";
        $sql_get_vw = "select * from product where type = 'vw' order by product_id desc limit 4";
        $result_get_vw = mysqli_query($connection, $sql_get_vw);
        $sql_get_akw = "select * from product where type = 'akw' order by product_id desc limit 4";
        $result_get_akw = mysqli_query($connection, $sql_get_akw);
        $sql_get_apw = "select * from product where type = 'apw' order by product_id desc limit 4";
        $result_get_apw = mysqli_query($connection, $sql_get_apw);
        $sql_get_qw = "select * from product where type = 'qw' order by product_id desc limit 4";
        $result_get_qw = mysqli_query($connection, $sql_get_qw);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <main>
        <div class="product-title">
            <p>
                <b>Váy - chân váy nữ</b>
                <a class="see-all" href="products/vaynu.php"> > Xem tất cả</a>
            </p>
            <hr>
        </div>
        <div class="products-container">
            <div class="row">
                <?php
                    while($row_get_vw = mysqli_fetch_assoc($result_get_vw)){
                ?>
                <div class="products" >
                    <div class="product-images-container">
                        <img class="product-images" src="images/products/<?php echo $row_get_vw['img'] ?>"/>
                        <div class="add-to-cart">
                            <p class="add_item" id="product-<?php echo $row_get_vw['product_id']?>">Thêm vào giỏ</p>
                        </div>
                    </div>
                    <div class="product-name">
                        <a href="#" class="p-name"><?php echo $row_get_vw['name'] ?></a>
                    </div>
                    <div class="product-price" id="<?php echo $row_get_vw['price'] ?>">
                        <p><?php echo $row_get_vw['price'] ?> VNĐ</p>
                    </div>
                </div>
                <?php
                    }
        ...
        <div class="product-title">
            <p>
                <b>Áo phông nữ</b>
                <a class="see-all" href="products/aophongnu.php"> > Xem tất cả</a>
            </p>
            <hr>
        </div>
        <div class="products-container">
        ...
        <div class="product-title">
            <p>
                <b>Quần nữ</b>
                <a class="see-all" href="products/quandainu.php"> > Xem tất cả</a>
            </p>
            <hr>
        </div>
        <div class="products-container">
            <div class="row">
                <?php
                    while($row_get_qw = mysqli_fetch_assoc($result_get_qw)){
                ?>
                <div class="products" >
                    <div class="product-images-container">
                        <img class="product-images" src="images/products/<?php echo $row_get_qw['img'] ?>"/>
                        <div class="add-to-cart">
                            <p class="add_item" id="product-<?php echo $row_get_qw['product_id']?>">Thêm vào giỏ</p>
                        </div>
                    </div>
                    <div class="product-name">
                        <a href="#" class="p-name"><?php echo $row_get_qw['name'] ?></a>
                    </div>
                    <div class="product-price" id="<?php echo $row_get_qw['price'] ?>">
                        <p><?php echo $row_get_qw['price'] ?> VNĐ</p>
                    </div>
                </div>
                <?php
                    }
        ...
        <div class="product-title">
            <p>
                <b>Áo khoác nữ</b>
                <a class="see-all" href="products/aokhoacnu.php"> > Xem tất cả</a>
            </p>
            <hr>
        </div>
        <div class="products-container">
            <div class="row">
                ...
                <div class="products" >
                    <div class="product-images-container">
                        ...
                        <div class="add-to-cart">
                            <p class="add_item" id="product-<?php echo $row_get_akw['product_id']?>">Thêm vào giỏ</p>
                        </div>
                    </div>
                    <div class="product-name">
                    ...
                    <div class="product-price" id="<?php echo $row_get_akw['price'] ?>">
                        <p><?php echo $row_get_akw['price'] ?> VNĐ</p>
                    </div>
                </div>
                <?php
                    }
